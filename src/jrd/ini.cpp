...
static const jrd_trg triggers[] =
{
	...
	{ "RDB$TRIGGER_13", (UCHAR) nam_ref_constr,
		/*RDB$TRIGGERS.RDB$TRIGGER_TYPE.PRE_MODIFY*/
		3, sizeof(trigger13),
		trigger13, 0, (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_14", (UCHAR) nam_chk_constr,
		/*RDB$TRIGGERS.RDB$TRIGGER_TYPE.PRE_MODIFY*/
		3, sizeof(trigger14),
		trigger14, 0, (UCHAR)ODS_8_0 },
	...
	{ "RDB$TRIGGER_24", (UCHAR) nam_r_fields,
		/*RDB$TRIGGERS.RDB$TRIGGER_TYPE.PRE_MODIFY*/
		3, sizeof(trigger24),
		trigger24, 0, (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_27", (UCHAR) nam_r_fields,
		/*RDB$TRIGGERS.RDB$TRIGGER_TYPE.POST_ERASE*/
		6, sizeof(trigger27),
		trigger27, 0, (UCHAR)ODS_8_0 },
	...
	{ "RDB$TRIGGER_34", (UCHAR) nam_rel_constr,
		/*RDB$TRIGGERS.RDB$TRIGGER_TYPE.POST_ERASE*/
		6, sizeof(trigger34),
		trigger34, TRG_ignore_perm, (UCHAR)ODS_8_1 },
	{ "RDB$TRIGGER_35", (UCHAR) nam_chk_constr,
		/*RDB$TRIGGERS.RDB$TRIGGER_TYPE.POST_ERASE*/
		6, sizeof(trigger35),
		trigger35, TRG_ignore_perm, (UCHAR)ODS_8_1 },
	{ "RDB$TRIGGER_36", (UCHAR) nam_fields,
		/*RDB$TRIGGERS.RDB$TRIGGER_TYPE.PRE_MODIFY*/
		3, sizeof(trigger36),
		trigger36, 0, (UCHAR)ODS_11_0 },
	{ 0, 0, 0, 0, 0, 0 }
};
...
{
	{ "RDB$TRIGGER_9", 0, "grant_obj_notfound", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_9", 1, "grant_fld_notfound", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_9", 2, "grant_nopriv", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_9", 3, "nonsql_security_rel", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_9", 4, "nonsql_security_fld", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_9", 5, "grant_nopriv_on_base", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_1", 0, "existing_priv_mod", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_2", 0, "systrig_update", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_3", 0, "systrig_update", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_5", 0, "not_rel_owner", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_24", 1, "cnstrnt_fld_rename", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_23", 1, "cnstrnt_fld_del", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_22", 1, "check_trig_update", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_21", 1, "check_trig_del", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_20", 1, "integ_index_mod", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_20", 2, "integ_index_deactivate", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_20", 3, "integ_deactivate_primary", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_19", 1, "integ_index_del", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_18", 1, "integ_index_seg_mod", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_17", 1, "integ_index_seg_del", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_15", 1, "check_cnstrnt_del", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_14", 1, "check_cnstrnt_update", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_13", 1, "ref_cnstrnt_update", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_12", 1, "ref_cnstrnt_notfound", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_12", 2, "foreign_key_notfound", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_10", 1, "primary_key_ref", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_10", 2, "primary_key_notnull", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_25", 1, "rel_cnstrnt_update", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_26", 1, "constaint_on_view", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_26", 2, "invld_cnstrnt_type", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_26", 3, "primary_key_exists", (UCHAR)ODS_8_0 },
	{ "RDB$TRIGGER_31", 0, "no_write_user_priv", (UCHAR)ODS_8_1 },
	{ "RDB$TRIGGER_32", 0, "no_write_user_priv", (UCHAR)ODS_8_1 },
	{ "RDB$TRIGGER_33", 0, "no_write_user_priv", (UCHAR)ODS_8_1 },
	{ "RDB$TRIGGER_24", 2, "integ_index_seg_mod", (UCHAR)ODS_11_0 },
	{ "RDB$TRIGGER_36", 1, "integ_index_seg_mod", (UCHAR)ODS_11_0 },
	{ 0, 0, 0, 0 }
};
